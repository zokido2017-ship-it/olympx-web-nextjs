  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <select
        ...
        aria-label={ariaLabel}
        className={cn(
          "h-11 w-full appearance-none rounded-xl border border-[#E8EEF5] bg-[#F8FAFC]/80 pl-10 pr-10 text-sm text-sportxo-navy shadow-none outline-none transition-all",
