...
export default async function OrganizationUpgradePage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-[720px] space-y-4 px-8 py-16">
      ...
      <h1 className="text-3xl font-bold text-slate-900">Upgrade tier</h1>
      <p className="text-slate-600">
        Tier upgrades will be available here. Return to the{" "}
